      ...
      <section className="py-12 bg-gray-50/30">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            {/* Consulting */}
            <div className="text-center bg-gradient-to-br from-brandTeal/5 to-brandBlue/5 p-6 rounded-lg border border-brandTeal/20">
              <h3 className="text-xl font-semibold text-brandBlue mb-3"> ייעוץ מקצועי</h3>
              <p className="text-muted-foreground mb-4">
                ייעוץ והכוונה מקצועית בשימוש בכלי GenAI לייעול ומיטוב תהליכים ארגוניים
              </p>
              <Link
                to="/consulting"
                className="inline-flex items-center gap-2 bg-gradient-to-r from-brandTeal to-brandBlue text-white px-6 py-3 rounded-lg font-semibold hover:opacity-90 transition-all duration-300"
              >
                💼 הזמנת ייעוץ
              </Link>
            </div>
