                ...
                <div className="mt-8">
                  ...
                  <div className="flex space-x-4 rtl:space-x-reverse">
                    <a 
                      ...
                      className="bg-white p-3 rounded-full shadow-sm text-gray-600 hover:text-primary transition-colors"
                    ...
                    <a 
                      href="https://twitter.com/shahargolan" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="bg-white p-3 rounded-full shadow-sm text-gray-600 hover:text-primary transition-colors"
                      aria-label="טוויטר"
