...
const ThankYou = () => {
  return (
    <Layout
      ...
      description="תודה שקבעת פגישה עם שחר גולן, מרצה ומומחה לבינה מלאכותית. נתראה בקרוב!"
    >
        ...
        <div className="container mx-auto px-4 py-24 relative z-10">
          ...
          >
            <div className="bg-white/80 backdrop-blur-sm p-8 md:p-12 rounded-xl shadow-lg border border-[#4a52a3]/10">
              ...
              >
                הפגישה נקבעה בהצלחה. נתראה בקרוב בזום!
              </motion.p>
              ...
              >
                ...
                <ul className="text-gray-700 text-right space-y-3" dir="rtl">
                  <li className="flex items-center gap-2">
                    <Video className="h-5 w-5 text-[#4a52a3]" />
                    <span>תקבל/י קישור לזום במייל</span>
                  </li>
                  <li className="flex items-center gap-2">
                  ...
                  <li className="flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#4a52a3]"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                    <span>מומלץ להתחבר מספר דקות לפני תחילת הפגישה</span>
                  </li>
                </ul>
              </motion.div>
