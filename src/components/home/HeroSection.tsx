...
const HeroSection = () => {
  return <section className="relative min-h-[90vh] flex items-center">
      ...
      <div className="absolute inset-0 overflow-hidden z-1">
        ...
        <div className="absolute w-96 h-96 bg-purple-300 rounded-full -top-12 -right-12 filter blur-3xl opacity-15" />
        <div className="absolute w-96 h-96 bg-purple-400 rounded-full bottom-0 left-1/3 filter blur-3xl opacity-15" />
      ...
      <div className="container mx-auto px-4 py-24 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          delay: 0.4
            ...
            <div className="text-white p-8 rounded-xl bg-black/40 backdrop-blur-sm border border-purple-500/20 max-w-md mt-24 shadow-lg shadow-purple-500/10 hover-scale">
